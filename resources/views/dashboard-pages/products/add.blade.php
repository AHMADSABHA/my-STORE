...
@section('page-title', 'اضافة منتج جديد');
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="name" type="text"
                                            ...
                                            placeholder="ادخل اسم المنتج" value="{{ old('name') }}">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="price" type="number" step="0.01" class="form-control @error('price') is-invalid  @enderror" id="price" placeholder="ادخل سعر المنتج" value="{{ old('price') }}">
                                        @error('price')
                                            <span class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input name="delivery_time" type="number" class="form-control @error('delivery_time') is-invalid  @enderror" id="delivery_time" placeholder="ادخل مدة التسليم" value="{{ old('delivery_time') }}">
                                        @error('delivery_time')
                                            <span class="error invalid-feedback" style="display: block;">{{ $message }}</span>
                                        @enderror
                                    </div>
